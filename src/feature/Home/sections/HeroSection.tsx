...
const HeroSection = () => {
  return (
    <motion.div
      ...
      whileInView="show"
      initial="hidden"
      className="space-y-10 md:mt-20 mt-10 max-w-[1250px] mx-auto px-5 bg"
    >
      ...
      <div className="flex max-[1024px]:flex-wrap sm:justify-between justify-center items-center gap-5 !mt-8">
        <motion.div
          ...
          whileInView="show"
          initial="hidden"
          className="card-type-2 relative bg-[rgb(0,0,0,0.2)] space-y-2 p-4 text-white h-[400px] rounded-2xl bg-cover w-full max-w-[300px]"
        >
          <Img
