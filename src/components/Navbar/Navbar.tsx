      ...
      >
            ...
            (item, idx) => (
              <div className="group">
                ...
                <div
                  ...
                  } h-[2px] duration-500 bg-black mx-auto`}
                ></div>
              </div>
            )
          )}
        ...
        <div className="lg:flex hidden items-center gap-x-5">
          <div className="relative w-fit flex items-center mx-auto group">
            ...
            />
            <input
              className="outline-none bg-neutral-100 group-hover:w-[300px] duration-700 w-[50px] group-hover:opacity-[1] opacity-0 rounded-full text-black pl-5 group-hover:pr-10 h-12"
